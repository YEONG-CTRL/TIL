...
import java.util.concurrent.locks.ReentrantLock; // 재진입 가능하다. = ready - wait - cpu - read ...
...
public class DiningPhilosophers {
    public static void main(String[] args) throws Exception {
        int numOfPhils = 5; // 5 철학자
        Philosopher[] philosophers = new Philosopher[numOfPhils]; // 철학자 배열
        DiningPhilosopherMonitor monitor = new DiningPhilosopherMonitor(numOfPhils); // 구현하고자 하는 모니터구조
